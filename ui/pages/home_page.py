...
class HomePage(ctk.CTkFrame):
    ...
    def _load_store(self) -> None:
        ...
        store_name = self._config_manager.store_name
    ...
    def _on_value_changed(
        ...
        *_args,
        ...
        try:
            current_value = self.value_variable.get()
            ...
            formatted = self._format_currency(cents)

            self.value_variable.set(formatted)
    ...
    def _format_currency(cents: int) -> str:
        ...
        return (
            f"R$ {reais_formatted},{centavos:02d}"
        )
    ...
    def _select_currency_value(
        ...
        self.after(
            10,
            lambda: self.value_entry.icursor("end"),
        )
    ...
    def get_cash_value(self) -> float:
        ...
        return self.get_cash_value_cents() / 100
    ...
    def _send_placeholder(self) -> None:
        """Ação temporária do botão de envio."""
        ...
        self.status_label.configure(
            text=(
                "Valor validado. O envio será "
                "habilitado na etapa de SMTP."
            ),
